              ...
              cellBuilder: (BuildContext context, TableVicinity vicinity) {
                if (vicinity.row == 0) {
                  ...
                  if(vicinity.column == 0) {
                    return TableViewCell(
                      child: Center(
                        child: Text('${state.data[vicinity.row - 1].code}'),
                      ),
                    );
                  }
                    ...
                    return TableViewCell(
                      child: Center(
                        child: Text('${state.data[vicinity.row - 1].name}'),
                      ),
                    );
                  }
                    ...
                    return TableViewCell(
                      child: Center(
                        child: Text('${state.data[vicinity.row - 1].type}'),
                      ),
                    );
                  }
                    ...
                    return TableViewCell(
                      child: Center(
                        child: Text('${state.data[vicinity.row - 1].quantity}'),
                      ),
                    );
                  }
                    ...
                    return TableViewCell(
                      child: Center(
                        child: Text('${state.data[vicinity.row - 1].unit}'),
                      ),
                    );
                  }
                  else{
